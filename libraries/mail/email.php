...
//        $this->Mailer = 'smtp';
//        $this->useSMTP(true, 'ssl://smtp.gmail.com', 'hungvietinfocontact@gmail.com', 'hungvietinfocontacthungvietinfocontact', 'ssl', 465);
...
// config to user gmail
    ...
    $email = 'mail.finalstyle@gmail.com';
    $pass = 'fs123456fs';
    $this -> useSMTP(true,$server,$email,$pass,'ssl',465);
//$this -> useSMTP(true,'ssl://smtp.gmail.com','info@ketnoigiaoduc.vn','=LZV!y}Lai;#','ssl',587);
    if ( ( $this->Mailer == 'mail' ) && ! function_exists('mail') )
    {
        Errors::setError(FSText :: _('MAIL_FUNCTION_DISABLED'),'alert');
        return false;
