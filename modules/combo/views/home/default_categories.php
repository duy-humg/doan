                ...
                <div class="hot_new_detail">
    				<?php if($news->image){?>
    					<a href="<?php echo $link_news; ?>" >
    						<img width="177" height="133" src="<?php echo URL_ROOT.str_replace('/original/','/resized/', $news->image); ?>" onerror="this.onerror=null;this.src='<?php echo URL_ROOT.'images/logo1lduoc.jpg'?>';" alt="<?php echo htmlspecialchars(@$news->title); ?>" />
    					</a>
    				<?php }?>
                    <div class="title">
