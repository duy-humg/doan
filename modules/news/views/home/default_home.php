			...
			<div class='item <?php echo ($i==0)?'row1':''?>'>
				...
				<?php if($news->image){?>				
					<a class='item-img' href="<?php echo $link_news; ?>">
						<img width="290" height="220" class="img-responsive" src="<?php echo URL_ROOT.str_replace('/original/','/original/', $news->image); ?>" onerror="this.onerror=null;this.src='<?php echo URL_ROOT.'images/logo1lduoc.jpg'?>';" alt="<?php echo htmlspecialchars(@$news->title); ?>" />
					</a>				
				<?php } ?>
