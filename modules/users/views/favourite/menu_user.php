...
<div class="list-menu-user">
    <div class="user-name-show clearfix">
        <div class="avt">
            <?php if($data->avatar){ ?>
                <img src="<?php echo URL_ROOT . str_replace('original', 'large', @$data_2->avatar); ?>" alt="avt">
            <?php }else{ ?>
    ...
    <ul>
        <li>
            ...
            <ul id="demo_tk" class="collapse ul-c2">
                <li class="li-c2">
                ...
                <li class="li-c2">
                    <a href="<?php echo FSRoute::_('index.php?module=users&view=address'); ?>">
                        <?php echo FSText::_("Địa chỉ");?>
                    </a>
                </li>
                <li class="li-c2">
                    <a class="" href="<?php echo FSRoute::_('index.php?module=users&view=users&task=changepass'); ?>">
        ...
        <li>
            <a  class="active" href="<?php echo FSRoute::_('index.php?module=users&view=favourite'); ?>">
