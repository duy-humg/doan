...
<?php if($user->userInfo->type == 2){?>
    ...
    <form class="form-horizontal" method="post" action="#" name="upinfo_form_user">
        <div class="form-group">
            <label for="username" class="control-label col-xs-2" style="text-align: left">Người đại diện </label>
            <div class="col-xs-4">
        ...
        <div class="form-group">
            <label for="username" class="control-label col-xs-2" style="text-align: left">Số điện thoại </label>
            <div class="col-xs-4">
        ...
        <div class="form-group">
            <label for="username" class="control-label col-xs-2" style="text-align: left">Email </label>
            <div class="col-xs-4">
