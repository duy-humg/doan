    ...
    <div class="form_created_user">
        <form class="form-horizontal" method="post" action="#" name="register_form_user">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-9">
                    <input type="text" class="form-control" id="username" name="username" placeholder="Username" readonly="true" value="<?php echo $user->userInfo->username . '_0' . (count($list_manager_user) + 1) ?>">
