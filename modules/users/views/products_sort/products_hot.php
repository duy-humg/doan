...
<aside class="new-contents">
    <div class="row body1">
        <div class="main-column-content col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="title-module"><h1>Sản phẩm bán chạy nhất</h1>
            </div>
                        ...
                        foreach ($list as $item) {
                            ...
                            <div class="image-check col-lg-2 col-md-2 col-sm-6 col-xs-6">
                                <a href="<?php echo $link; ?>">
                                    <img src="<?php echo URL_ROOT.str_replace('original', 'tiny', $item->image); ?>" onerror="this.src='/images/not_picture.png'"  class="img-responsive">
