...
function check_form_list_user() {
    if (!notEmpty2("month_to", "Chọn thời gian", "Bạn chưa chọn thời gian thi"))
    {
        return false;
    }
    if (!notEmpty2("year_to", "Chọn thời gian", "Bạn chưa chọn thời gian thi"))
    {
        return false;
    }
    if (!notEmpty2("month_from", "Chọn thời gian", "Bạn chưa chọn thời gian thi"))
    {
        return false;
    }
    if (!notEmpty2("year_from", "Chọn thời gian", "Bạn chưa chọn thời gian thi"))
    {
        return false;
    }
...
function checkFormsubmit()
{
    ...
    if (!notEmpty2("name", "Nhập họ tên", "Bạn chưa nhập họ tên "))
    {
        return false;
    }
...
//    }
    ...
    if (!lengthMax("cmt", 12, "Trường này chỉ cho phép nhập 12 kí tự"))
    {
        $('#cmt').focus();
        return false;
    }
