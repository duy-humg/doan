...
<section>
    <div class="container">
        ...
        <div class="col-md-12 body3">
            <form action="<?php echo FSRoute::_('index.php?module=products&view=pay_not&task=success'); ?>"
                ...
                <div id="body-content">
                        ...
                        <div class="body-content--1a clearfix">
                            <div class="col-md-4">
                                <div class="thongtin-muahang">
                                    ...
                                    <a href="<?php echo FSRoute::_("index.php?module=products&view=pay_not&task=step_address") ?>">Chỉnh
                                        sửa</a>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="vanchuyen-thanhtoan">
                                    <!--                                <h5>-->
                                    <?php //echo FSText::_("HÌNH THỨC GIAO HÀNG") ?><!--</h5>-->
                                    <!--                                <p>-->
                                    <?php //echo $info_guest['hinhthuc']; ?><!--</p>-->
                                    <!--                                <a style="margin-bottom: 15px;display: block;"-->
                                    <!--                                   href="-->
                                    <?php //echo FSRoute::_("index.php?module=products&view=pay_not&task=step_address") ?><!--">Thay-->
                                    <!--                                    đổi</a>-->
                                    ...
                                    <p><?php
                                        ...
                                        ?></p>
                                    <a href="<?php echo FSRoute::_("index.php?module=products&view=pay_not&task=pay_code") ?>">Thay
                                        đổi</a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        foreach ($list_cart as $item) {
                                            ...
                                            <li class="donhang-1">
                                                ...
                                                <div class="chitiet-donhang1">
                                                    ...
                                                    <p><?php echo FSText::_("Giá"); ?>:
                                                        <b><?php echo format_money($price); ?></b></p>
                                                    <p><?php echo FSText::_("Số lượng"); ?>:
                                                        <strong><?php echo $item[1]; ?></strong> <span><a
                                                                    href="<?php echo FSRoute::_("index.php?module=products&view=cart") ?>">  Thay đổi</a></span>
                                                    </p>
                                        ...
                                        <div class="list-vanchuyen clearfix">
                                            <div class="radio-vanchuyen1 clearfix">
                                                ...
                                                <input type="radio" name="hinhthuc"
                                                       value="lấy hàng trong ngày" <?php if ($info_guest['hinhthuc'] == 'lấy hàng trong ngày') {
                                                    echo 'checked';
                                                } ?> id="one-day">
                                                <label for="one-day">
                                                    <span></span>&nbsp;
                                            ...
                                            <div class="radio-vanchuyen2 clearfix">
                                                ...
                                                <input type="radio" name="hinhthuc" value="lấy hàng trong 1 giờ"
                                                       id="one-hour" <?php if ($info_guest['hinhthuc'] == 'lấy hàng trong 1 giờ') {
                                                    echo 'checked';
                                                } ?>>
                                                <label for="one-hour">
                                                    <span></span>&nbsp;
                                    ...
                                    <div class="hinhthuc-giaohang">
                                        ...
                                        <div class="list-vanchuyen clearfix">
                                            <div class="radio-vanchuyen1 clearfix">
                                                ...
                                                <input type="radio" name="hinhthuc"
                                                       value="giao hàng tiêu chuẩn" <?php if ($info_guest['hinhthuc'] == 'giao hàng tiêu chuẩn') {
                                                    echo 'checked';
                                                } ?> id="ghtktc">
                                                <label for="ghtktc">
                                                    <span></span>&nbsp;
                                            ...
                                            <div class="radio-vanchuyen2 clearfix">
                                                ...
                                                <input type="radio" name="hinhthuc" value="giao hàng nhanh"
                                                       id="ghtkn" <?php if ($info_guest['hinhthuc'] == 'giao hàng nhanh') {
                                                    echo 'checked';
                                                } ?>>
                                                <label for="ghtkn">
                                                    <span></span>&nbsp;
                                            ...
                                            <div class="radio-vanchuyen2 clearfix">
                                                ...
                                                <input type="radio" name="hinhthuc" value="giao hàng siêu tốc"
                                                       id="ghtkst" <?php if ($info_guest['hinhthuc'] == 'giao hàng siêu tốc') {
                                                    echo 'checked';
                                                } ?>>
                                                <label for="ghtkst">
                                                    <span></span>&nbsp;
                    ...
                    <div class="col-md-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="purchase-detail--right">
                                                    ...
                                                    <p class="p2-right">
                                                        <span><?php echo format_money($info_guest['feeghtk']); ?></span>
                                                    </p>
                                                    <p class="p1-right"><?php if ($info_guest['discount_money']) {
                                                            echo format_money($info_guest['discount_money']);
                                                        } else {
                                                            echo '0đ';
                                                        } ?></p>
                                                </div>
                        ...
                        <!--                            <label for="show_add_code">-->
                        <?php //echo FSText::_("Mã giảm giá/Quà tặng"); ?><!--</label>-->
                        <!--                        </div>-->
                        <!--                        <div class="code_down_price" id="code_down_price" style="display: block">-->
                        <!--                            <div class="row">-->
                        <!--                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">-->
                        <!--                                    <input type="text" name="code_down" id="code_down" placeholder="-->
                        <?php //echo FSText::_("Nhập mã giảm giá ở đây") ?><!--"/>-->
                        <!--                                </div>-->
                        <!--                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 text-center">-->
                        <!--                                    <a href="javascript:void(0)" class="add_code_price"-->
                        <!--                                       id="add_code_price">-->
                        <?php //echo FSText::_("Đồng ý"); ?><!--</a>-->
                        ...
                        <div class="body-content--2c">
                            <div class="rules">
                                ...
                                <label for="agree">
                                <span><?php echo FSText::_("Tôi đồng ý với") ?> <a
                                            href="#"><?php echo FSText::_("điều khoản") ?></a> &
