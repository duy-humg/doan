                        ...
                        <div class="left-box-list">
                            <div class="list-thanh-toan">
                                <ul>
                                    ...
                                    <li class="clearfix">
                                        <input type="radio" name="pay_book" id="put_bank" value="1"
                                               onclick="yesnoCheck()">
                                        <label for="put_bank"
                                               class="chuyen-khoan"><?php echo FSText::_("Thanh toán bằng chuyển khoản qua ngân hàng"); ?>
                                            <span><?php echo FSText::_("Quý khách sẽ thanh toán bằng hình thức chuyển khoản qua tài khoản ngân hàng của Geni."); ?></span></label>
...
<!--                                        <div class="choose-bank clearfix">-->
<!--                                            <ul class="bank">-->
<!--                                                <li class="visa">-->
<!--                                                    <div class="radio-visa">-->
<!--                                                        <input type="radio" name="bank" id="visa" value="" checked="checked">-->
<!--                                                        <label class="clearfix" for="visa">-->
<!--                                                            <span></span>-->
<!--                                                            <span><img src="--><?php //echo URL_ROOT;?><!--images/img_thanhtoan/visa.png" alt="Hình ảnh"></span>-->
<!--                                                            <p>Thẻ visa mua hàng 1</p>-->
<!--                                                        </label>-->
<!--                                                    </div>-->
<!--                                                </li>-->
<!--                                                <li class="vietcombank">-->
<!--                                                    <div class="radio-vietcombank">-->
<!--                                                        <input type="radio" name="bank" id="vietcombank" value="">-->
<!--                                                        <label class="clearfix" for="vietcombank">-->
<!--                                                            <span></span>-->
<!--                                                            <span><img src="../img/img_thanhtoan/vietcombank.png" alt="Hình ảnh"></span>-->
<!--                                                            <p>Thẻ Vietcombank</p>-->
<!--                                                        </label>-->
<!--                                                    </div>-->
<!--                                                </li>-->
<!--                                                <li class="vietinbank">-->
<!--                                                    <div class="radio-vietinbank">-->
<!--                                                        <input type="radio" name="bank" id="vietinbank" value="">-->
<!--                                                        <label class="clearfix" for="vietinbank">-->
<!--                                                            <span></span>-->
<!--                                                            <span><img src="../img/img_thanhtoan/vietinbank.png" alt="Hình ảnh"></span>-->
<!--                                                            <p>Thẻ Vietinbank</p>-->
<!--                                                        </label>-->
<!--                                                    </div>-->
<!--                                                </li>-->
                        ...
                        <div class="conditional-terms condi-mb">
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                                    <input type="submit" value="<?php echo FSText::_("Đặt mua"); ?>">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 right-cart">
                                        ...
                                        <li>
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                    ...
                                                    <p><?php echo format_money($price * $item[1]); ?></p>
                                                </div>
                                            </div>
                                        </li>
                                    <?php }
                            ...
                            <div class="price-total">
                                <ul>
                                    ...
                                    <input type="hidden" value="<?php echo $feeghtk; ?>" name="ship"
                                           id="ship">
                                    <?php $total_price += $feeghtk; ?>
                                    <li><?php echo FSText::_("Tổng chi phí vận chuyển"); ?><span
                                                class="blue-price"><?php
                                                echo format_money($feeghtk);
                                           ?></span></li>
                                    <!--                                <li> -->
                                    <? //= FSText::_('Đơn vị vận chuyển') ?><!--<span-->
                                    <!--                                            class="red-price">-->
                                    <? //= $transport ?><!--</span></li>-->
                                    <!--                                <li> -->
                                    <? //= FSText::_(' ADCBook hỗ trợ phí vận chuyển') ?><!--<span-->
                                    <!--                                            class="red-price">-->
                                    <?php //if ($ii == 1) {
                                    //                                            echo $feeghtk;
                                    //                                        } elseif ($ii == 2) {
                                ...
                                <p class="clearfix"><?php echo FSText::_("Số tiền cần phải trả"); ?><span
                                            class="fred red-price"
                                            id="total_money"><?php echo format_money($total_price); ?></span>
                                </p>
                        ...
                        <div class="conditional-terms condi-mb">
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                                    <input type="submit" onclick="showpre()"
                                           value="<?php echo FSText::_("Đặt Mua"); ?>">
                                </div>
                            </div>
                        </div>
