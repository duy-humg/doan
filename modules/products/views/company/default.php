...
<div class="row">
            ...
            <div class="panel-heading-company">
                <h4 class="panel-title">
                    <a class="accordion-toggle" href="javascript:void(0)">
                        <?php echo FSText::_("Nhà xuất bản"); ?>
                    </a>
                </h4>
            </div>
            <div class="panel-collapse-company" style="height: 400px; overflow-y: scroll;">
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        <a rel="" href="<?php echo FSRoute::_('index.php?module=products&view=company&code='.$item->alias); ?>" class="list-group-item"><?php echo $item->name; ?> <span></span></a>
                    </li>
                    <?php } ?>
                </ul>
            </div>
    ...
    <div class="main-column-content col-lg-10 col-md-10 col-sm-12 col-xs-12">
        <div class="title-module"><h1><?php echo FSText::_('Nhà sách'); ?></h1><p>Có <span><?php echo $total; ?> </span>sản phẩm</p></div>
