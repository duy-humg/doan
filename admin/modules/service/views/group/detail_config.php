            ...
            <table class="table table-hover table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th><?php echo FSText::_('% tích lũy') ?></th>
                        <th width="50px">%</th>
...
function save2_item(id,is_save = 0){
    ...
    $.ajax({
        type: 'POST',
        url: 'index2.php?module=service&view=group&task=save_item&raw=1',
        data: {
...
function delete2_item(id,is_item = 0){
    ...
    if(is_item){
        ...
        $.ajax({
            type: 'POST',
            url: 'index2.php?module=service&view=group&task=delete_item&raw=1',
            data: {ids: ids},
            dataType: 'text',
            success: function(data) {
                if(data == 1){
