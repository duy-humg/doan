	...
	class NewsModelsNews extends FSModels
	{
		...
		function __construct()
		{
			...
			$this -> arr_img_paths = array(
                                            array('resized',620,"",'resize_image_fix_width'),

                                            array('large_home',460,307,'cut_image'),
                                            array('large',620,413,'cut_image'),
                                            array('normal',300,200,'cut_image'),
                                            array('small_home',160,107,'cut_image'),
                                            array('small',170,114,'cut_image'),
