<?php 
	class SlideshowModelsSlideshow extends FSModels
	{
		...
		function __construct()
		{
			...
			$this -> arr_img_paths = array(array('slideshow_large',1920,480,'resized_not_crop'));
			...
			$this -> arr_img_paths_thumb = array(array('small',1920,480,'resized_not_crop'));
			parent::__construct();
		}
		...
		function  save($row = array(),$use_mysql_real_escape_string = 0){
    		...
    		if($image_name_thumb){
    			$image_thumb = $this->upload_image('image_thumb','_'.time(),20000000,$this -> arr_img_paths_thumb);
    			if($image_thumb){
