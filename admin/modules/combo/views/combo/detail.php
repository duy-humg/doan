...
//TemplateHelper::dt_edit_text(FSText:: _('Người đăng'), 'member', @$data->member);
TemplateHelper::dt_edit_text(FSText:: _('Alias'), 'alias', @$data->alias, '', 60, 1, 0, FSText::_("Can auto generate"));
TemplateHelper::dt_edit_image(FSText:: _('Hình ảnh'), 'image', str_replace('/original/', '/small/', URL_ROOT . @$data->image));
TemplateHelper::dt_edit_image(FSText:: _('Hình ảnh mobile'), 'icon', str_replace('/original/', '/small/', URL_ROOT . @$data->icon));
