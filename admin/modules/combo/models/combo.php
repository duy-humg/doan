<?php 
	class ComboModelsCombo extends FSModels
	{
		var $limit;
		var $prefix ;
		function __construct()
		{
			...
			$this -> arr_img_paths = array(
                                            array('resized',380,"",'resize_image_fix_width'),

                                            array('large',380,207,'cut_image'),
                                            array('normal',396,120,'cut_image'),
                                            array('normal',500,220,'cut_image'),
//                                            array('small_home',160,107,'cut_image'),
                                            array('small',150,"",'resize_image_fix_width'),
//                                            array('cut',360,230,'cut_image'),
                                        );
			$this -> table_category_name = FSTable_ad::_('fs_combo_categories');
            $this -> table_name = FSTable_ad::_('fs_combo');
