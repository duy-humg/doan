...
$filter_status1['title'] = FSText::_('Trạng thái Vnpay');
...
//$list_config[] = array('title' => FSText:: _('Trạng thái Vnpay'), 'field' => 'status1', 'ordering' => 1, 'type' => 'status', 'arr_params' => $array_obj_status1);
//$list_config[] = array('title' => FSText:: _('Trạng thái Vnpay'), 'field' => 'status1', 'ordering' => 1, 'type' => 'text');
