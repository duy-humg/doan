...
//	$fitler_config['filter'][] = $filter_categories;																																																																																																																																																																																																																																																																																																																																																																																																																						
	...
	//	CONFIG	
	$list_config = array();
//	$list_config[] = array('title'=>'Tiêu đề','field'=>'title','ordering'=> 1, 'type'=>'text','col_width' => '25%','arr_params'=>array('size'=> 30));
	$list_config[] = array('title'=>'Nội dung câu hỏi','field'=>'question','ordering'=> 1, 'type'=>'text','col_width' => '25%','arr_params'=>array('size'=> 30));
//	$list_config[] = array('title'=>'Image','field'=>'image','type'=>'image','no_col'=>1,'arr_params'=>array('search'=>'/original/','replace'=>'/small/'));
//	$list_config[] = array('title'=>'Trả lời','field'=>'summary','type'=>'edit_text','col_width' => '20%','arr_params'=>array('size'=>30,'rows'=>8));
...
//	$list_config[] = array('title'=>'Lượt xem','field'=>'hits','ordering'=> 1, 'type'=>'text','arr_params'=>array('size'=>3));
