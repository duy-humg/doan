<!-- HEAD -->
    ...
    <?php
    TemplateHelper::dt_checkbox(FSText::_('Target'),'target',@$data -> target,'_self',array('_self'=>FSText :: _("Current window"),'_blank'=>FSText :: _("New window")));

//    TemplateHelper::dt_checkbox(FSText::_('Kiểu hiển thị'),'is_type',@$data -> is_type,0,array(0=>'dropdown',1=>'mega dropdown'));
    //TemplateHelper::dt_edit_text(FSText :: _('Chỉ số độ rộng của submenu'),'width_submenu',@$data -> width_submenu,'','','','','','','col-sm-2','col-sm-2');
    ...
    //TemplateHelper::jscolorpicker(FSText:: _('Màu nền'),'bk_color',@$data -> bk_color,'','','','col-sm-2','col-sm-2');
