...
$toolbar->addButton('back',FSText :: _('Cancel'),'','back.png');   
	...
	TemplateHelper::dt_text(FSText :: _('Bài viết'),$news->title);
	TemplateHelper::dt_text(FSText :: _('Id bài viết'),$news->id);
	TemplateHelper::dt_text(FSText :: _('Danh mục'),$news->category_name);
