...
<fieldset id="zone-upload-analytics">
    <!--    --><?php //echo 1;die; ?>
    <?php if (@$cat) { ?>
        <legend class="title" style="color:#000;">Import sản phẩm của danh mục <strong
                    style="color:red;"><?php echo $cat->name; ?></strong></legend>
    <?php } else { ?>
        <legend class="title">Cập nhật sản phẩm từ excel</legend>
    <?php } ?>
    <div id="content-form-upload-import-excel">
        <form id="frm-import-excel-for-product" action="index.php?module=products&view=import&task=import_product"
              method="POST" enctype="multipart/form-data">
            <div class="one-row-input">
                <div class="input">
                    <div id='frm-editing-upload-league-excel_wrap'>
                        <span>File excel: </span>
                        <input type="file" size="35"
                               id="frm-editing-upload-league-excel"
                               class="football-data-excel-file-import"
                               name="excel"><span
                                id="frm-editing-upload-league-excel_wrap_labels">
