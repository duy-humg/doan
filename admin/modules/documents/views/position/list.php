<?php  
	global $toolbar;
	$toolbar->setTitle(FSText :: _('Danh sách chức vụ') );
...
//	$toolbar->addButton('edit',FSText :: _('Edit'),FSText :: _('You must select at least one record'),'edit.png'); 
	...
	//	CONFIG	
	$list_config = array();
	$list_config[] = array('title'=>'Tên vị trí','field'=>'name','ordering'=> 1, 'type'=>'text','align'=>'left','col_width' => '25%','arr_params'=>array('size'=> 30));
