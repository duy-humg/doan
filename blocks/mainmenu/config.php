	...
	$params = array (
		...
		'style' => array(
					...
					'value' => array(
                                    ...
                                    'default_content' => FSText::_('Menu trang tĩnh'),
//                                    'link_menu'=> 'Menu Liên kết',
//                                    'default_news' => FSText::_('Tư vấn tuyển sinh'),
                                    'bottom' => FSText::_('Menu bottom dưới footer'),
                                    'leftmenu1' => FSText::_('Menu trái trang chủ 1'),
                                    'leftmenu2' => FSText::_('Menu trái trang chủ 2'),
                                    'leftmenu3' => FSText::_('Menu trái trang chủ 3'),
