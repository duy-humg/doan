...
//        var_dump($list_quick);die;
        ...
        if (!count($list))
            return;
        if ($style == 'megamenu' || $style == 'megamenu_moblie' || $style == 'icon_and_popup' || $style == 'leftmenu1' || $style == 'leftmenu1_mb') {
            $level_0 = array();
            $children = array();
            $arr_activated = array();
